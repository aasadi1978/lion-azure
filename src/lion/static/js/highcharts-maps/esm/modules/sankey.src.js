 ...
 *
 * */
/* harmony default export */ const Series_NodesComposition = NodesComposition; // external ["../highcharts.src.js","default","Point"]

const external_highcharts_src_js_default_Point_namespaceObject =
  __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__['default'].Point;
var external_highcharts_src_js_default_Point_default =
  /*#__PURE__*/ __webpack_require__.n(
    external_highcharts_src_js_default_Point_namespaceObject
...
const { column: ColumnSeries } =
  external_highcharts_src_js_default_SeriesRegistry_default().seriesTypes;
...
class SankeyPoint extends ColumnSeries.prototype.pointClass {
  ...
  applyOptions(options, x) {
    external_highcharts_src_js_default_Point_default().prototype.applyOptions.call(
      this,
      options,
      x
    );
  ...
  getClassName() {
    return (
      ...
      external_highcharts_src_js_default_Point_default().prototype.getClassName.call(
        this
      )
    );
  }
    ...
    offset(node, factor) {
      ...
      for (let i = 0; i < column.length; i++) {
        ...
        const directionOffset =
            node.options[
              series.chart.inverted ? 'offsetHorizontal' : 'offsetVertical'
            ],
...
/* harmony default export */ const Sankey_SankeyColumnComposition =
  SankeyColumnComposition; // external ["../highcharts.src.js","default","Color"]

const external_highcharts_src_js_default_Color_namespaceObject =
  __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__['default'].Color;
var external_highcharts_src_js_default_Color_default =
  /*#__PURE__*/ __webpack_require__.n(
...
function getColor(node, options) {
  ...
  const variateColor = (color) => {
    ...
    if (
      ...
      return external_highcharts_src_js_default_Color_default()
        .parse(color)
  ...
  if (node) {
    ...
    if (getColorByPoint) {
      colorIndexByPoint =
        point.index % (colors ? colors.length : chartOptionsChart.colorCount);
...
/* harmony default export */ const Series_TreeUtilities = TreeUtilities; // external ["../highcharts.src.js","default","SVGElement"]
  ...
  createNodeColumns() {
    ...
    for (const node of this.nodes) {
      ...
      if (!columns[node.column]) {
        columns[node.column] = Sankey_SankeyColumnComposition.compose([], this);
      }
    ...
    const translationFactor = this.translationFactor,
      ...
      fromNodeTop = crisp(
        SankeySeries_pick(
          ...
          column.sankeyColumn.top(translationFactor) + nodeOffset.relativeTop
        ),
        borderWidth
      ),
      left =
        crisp(this.colDistance * node.column + borderWidth / 2, borderWidth) +
