...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(
      ...
      root['_Highcharts']['Point'],
      root['_Highcharts']['Color'],
      root['_Highcharts']['SVGElement']
    );
  else if (typeof define === 'function' && define.amd)
    define('highcharts/modules/sankey', ['highcharts/highcharts'], function (
      amd1
    ) {
      return factory(
        amd1,
  ...
  (
    ...
    return /******/ (() => {
      ...
      const { column: ColumnSeries } =
        highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
          .seriesTypes;

      const { defined: SankeyPoint_defined } =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
      /* *
       *
       *  Class
       ...
       *
       * */
      /* harmony default export */ const Sankey_SankeyPoint = SankeyPoint; // ./code/es-modules/Series/Sankey/SankeySeriesDefaults.js
       ...
       *
       * */
      /* harmony default export */ const Sankey_SankeySeriesDefaults =
        SankeySeriesDefaults; // ./code/es-modules/Series/Sankey/SankeyColumnComposition.js
      ...
      const {
        defined: SankeyColumnComposition_defined,
        getAlignFactor,
        relativeLength,
      } = highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
      /* *
       ...
       *
       * */
      /* harmony default export */ const Sankey_SankeyColumnComposition =
      ...
      const {
        extend: TreeUtilities_extend,
        isArray,
        isNumber,
        isObject,
        merge: TreeUtilities_merge,
        pick: TreeUtilities_pick,
        relativeLength: TreeUtilities_relativeLength,
      } = highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
      /* *
       *
       *  Functions
      ...
      /* harmony default export */ const Extensions_TextPath = TextPath; // ./code/es-modules/Series/Sankey/SankeySeries.js
      ...
      const { column: SankeySeries_ColumnSeries, line: LineSeries } =
        highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
          .seriesTypes;
      ...
      const {
        getLevelOptions: SankeySeries_getLevelOptions,
        getNodeWidth: SankeySeries_getNodeWidth,
      } = Series_TreeUtilities;

      const {
        clamp,
        crisp,
        extend: SankeySeries_extend,
        isObject: SankeySeries_isObject,
        merge: SankeySeries_merge,
        pick: SankeySeries_pick,
        relativeLength: SankeySeries_relativeLength,
        stableSort,
      } = highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
       ...
       *
       * */
      /* harmony default export */ const Sankey_SankeySeries =
       ...
       */
      (''); // Detach doclets above // ./code/es-modules/masters/modules/sankey.src.js

      /* harmony default export */ const sankey_src =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
