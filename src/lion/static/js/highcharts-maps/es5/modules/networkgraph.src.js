...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(
      require('highcharts'),
      require('highcharts')['SVGElement'],
      require('highcharts')['SeriesRegistry']
    );
  else if (typeof define === 'function' && define.amd)
    define('highcharts/modules/networkgraph', [
      ['highcharts/highcharts'],
      ['highcharts/highcharts', 'SVGElement'],
      ['highcharts/highcharts', 'SeriesRegistry'],
    ], factory);
  else if (typeof exports === 'object')
    exports['highcharts/modules/networkgraph'] = factory(
      require('highcharts'),
      require('highcharts')['SVGElement'],
      require('highcharts')['SeriesRegistry']
    );
    ...
    root['Highcharts'] = factory(
      root['Highcharts'],
      root['Highcharts']['SVGElement'],
      root['Highcharts']['SeriesRegistry']
    );
})(
  this,
  function (
    ...
    return /******/ (function () {
      ...
      __webpack_require__.d(__webpack_exports__, {
        default: function () {
          return /* binding */ networkgraph_src;
        },
      });

      // EXTERNAL MODULE: external {"amd":["highcharts/highcharts"],"commonjs":["highcharts"],"commonjs2":["highcharts"],"root":["Highcharts"]}
      var highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_ =
        __webpack_require__(944);
      var highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default =
      ...
      var highcharts_SVGElement_commonjs_highcharts_SVGElement_commonjs2_highcharts_SVGElement_root_Highcharts_SVGElement_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      function onMouseDown(point, event) {
        ...
        var normalizedEvent =
          ((_a = this.chart.pointer) === null || _a === void 0
            ? void 0
            : _a.normalize(event)) || event;
        point.fixedPosition = {
      ...
      function onMouseMove(point, event) {
        ...
        if (point.fixedPosition && point.inDragMode) {
          var series = this,
            chart = series.chart,
            normalizedEvent =
              ((_a = chart.pointer) === null || _a === void 0
                ? void 0
                : _a.normalize(event)) || event,
      ...
      /* harmony default export */ var Series_DragNodesComposition =
        DragNodesComposition; // ./code/es5/es-modules/Series/GraphLayoutComposition.js
      ...
      var GraphLayoutComposition_composed =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
          .composed;

      var GraphLayoutComposition_addEvent =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .addEvent,
        GraphLayoutComposition_pushUnique =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .pushUnique;
      /* *
       *
      ...
      function GraphLayoutComposition_compose(ChartClass) {
        if (
          ...
          GraphLayoutComposition_addEvent(
            ChartClass,
            'afterPrint',
            onChartAfterPrint
          );
      ...
      function onChartRender() {
        ...
        if (
          ...
          !((_a = this.pointer) === null || _a === void 0
            ? void 0
            : _a.hasDragged)
        ) {
      ...
      /* harmony default export */ var Series_GraphLayoutComposition =
      ...
      var highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      (function (NodesComposition) {
        ...
        function updateNode(options, redraw, animation, runEvent) {
          ...
          var nodes = this.series.options.nodes,
            ...
            linkConfig =
              data === null || data === void 0 ? void 0 : data[this.index];
          ...
          if (this.isNode) {
            ...
            if (data) {
              if (linkConfig) {
                ...
                // Remove node from lion.config if there's more nodes than links
       ...
       *
       * */
      /* harmony default export */ var Series_NodesComposition =
        NodesComposition; // ./code/es5/es-modules/Series/Networkgraph/NetworkgraphPoint.js
      ...
      var NetworkgraphPoint_a =
          highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
            .series,
        NetworkgraphPoint_seriesProto = NetworkgraphPoint_a.prototype,
        Point = NetworkgraphPoint_a.prototype.pointClass;

      var NetworkgraphPoint_addEvent =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .addEvent,
        css =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .css,
        NetworkgraphPoint_defined =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .defined,
        NetworkgraphPoint_extend =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .extend,
        NetworkgraphPoint_pick =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .pick;
      /* *
       *
      ...
      var NetworkgraphPoint = /** @class */ (function (_super) {
        ...
        function NetworkgraphPoint(series, options, x) {
          ...
          if (
            _this.series.options.draggable &&
        ...
        NetworkgraphPoint.prototype.destroy = function () {
          ...
          this.series.layout.removeElementFromCollection(
            this,
            this.series.layout[this.isNode ? 'nodes' : 'links']
          );
        ...
        NetworkgraphPoint.prototype.getLinkAttributes = function () {
          ...
          return {
            'stroke-width': NetworkgraphPoint_pick(
              pointOptions.width,
              linkOptions.width
            ),
            stroke: pointOptions.color || linkOptions.color,
            dashstyle: pointOptions.dashStyle || linkOptions.dashStyle,
            opacity: NetworkgraphPoint_pick(
          ...
          if (point.isNode) {
            ...
            []
              ...
              .forEach(function (linkFromTo) {
                ...
                NetworkgraphPoint_seriesProto.removePoint.call(
                  series,
            ...
            // Remove node options from lion.config
            while (i--) {
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_NetworkgraphPoint =
        NetworkgraphPoint; // ./code/es5/es-modules/Series/Networkgraph/NetworkgraphSeriesDefaults.js
      ...
      var NetworkgraphSeriesDefaults = {
        ...
        dataLabels: {
          ...
          linkFormatter: function () {
            return this.fromNode.name + '<br>' + this.toNode.name;
          },
          /**
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_NetworkgraphSeriesDefaults =
       ...
       */
      (''); // Adds doclets above to transpiled file // ./code/es5/es-modules/Series/Networkgraph/EulerIntegration.js
      ...
      /* harmony default export */ var Networkgraph_EulerIntegration =
        EulerIntegration; // ./code/es5/es-modules/Series/Networkgraph/QuadTreeNode.js
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_QuadTreeNode = QuadTreeNode; // ./code/es5/es-modules/Series/Networkgraph/QuadTree.js
      ...
      var QuadTree = /** @class */ (function () {
         ...
         */
        QuadTree.prototype.visitNodeRecursive = function (
          node,
          beforeCallback,
          afterCallback
        ) {
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_QuadTree = QuadTree; // ./code/es5/es-modules/Series/Networkgraph/VerletIntegration.js
      ...
      function VerletIntegration_barycenter() {
        var gravitationalConstant = this.options.gravitationalConstant || 0,
          xFactor =
            (this.barycenter.xFactor - (this.box.left + this.box.width) / 2) *
            gravitationalConstant,
          yFactor =
            (this.barycenter.yFactor - (this.box.top + this.box.height) / 2) *
            gravitationalConstant;
        this.nodes.forEach(function (node) {
          if (!node.fixedPosition) {
      ...
      function VerletIntegration_integrate(layout, node) {
        var friction = -layout.options.friction,
          ...
          prevY = node.prevY,
          // Apply friction:
          frictionX = (node.plotX + node.dispX - prevX) * friction,
          frictionY = (node.plotY + node.dispY - prevY) * friction,
          abs = Math.abs,
          signX = abs(frictionX) / (frictionX || 1), // Need to deal with 0
          signY = abs(frictionY) / (frictionY || 1),
          // Apply max speed:
          diffX = signX * Math.min(maxSpeed, Math.abs(frictionX)),
          diffY = signY * Math.min(maxSpeed, Math.abs(frictionY));
      ...
      /* harmony default export */ var Networkgraph_VerletIntegration =
        VerletIntegration; // ./code/es5/es-modules/Series/Networkgraph/ReingoldFruchtermanLayout.js
      ...
      var clamp =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .clamp,
        ReingoldFruchtermanLayout_defined =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .defined,
        isFunction =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
        ...
        fireEvent =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .fireEvent,
        ReingoldFruchtermanLayout_pick =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .pick;
      ...
      var ReingoldFruchtermanLayout = /** @class */ (function () {
        ...
        ReingoldFruchtermanLayout.compose = function (ChartClass) {
          ...
          Series_GraphLayoutComposition.integrations.euler =
            Networkgraph_EulerIntegration;
          Series_GraphLayoutComposition.integrations.verlet =
            Networkgraph_VerletIntegration;
        ...
        ReingoldFruchtermanLayout.prototype.init = function (options) {
          ...
          this.attractiveForce = ReingoldFruchtermanLayout_pick(
            options.attractiveForce,
            this.integration.attractiveForceFunction
          );
          this.repulsiveForce = ReingoldFruchtermanLayout_pick(
            options.repulsiveForce,
            this.integration.repulsiveForceFunction
          );
          this.approximation = options.approximation;
        };
        ReingoldFruchtermanLayout.prototype.updateSimulation = function (
          enable
        ) {
          this.enableSimulation = ReingoldFruchtermanLayout_pick(
            enable,
        ...
        ReingoldFruchtermanLayout.prototype.step = function () {
          ...
          if (this.enableSimulation) {
            for (
              var _b = 0, allSeries_1 = allSeries;
              _b < allSeries_1.length;
              _b++
            ) {
        ...
        ReingoldFruchtermanLayout.prototype.addElementsToCollection = function (
          elements,
          collection
        ) {
          for (
            var _i = 0, elements_1 = elements;
            _i < elements_1.length;
            _i++
          ) {
        ...
        ReingoldFruchtermanLayout.prototype.removeElementFromCollection =
        ...
        ReingoldFruchtermanLayout.prototype.setMaxIterations = function (
          maxIterations
        ) {
          this.maxIterations = ReingoldFruchtermanLayout_pick(
            maxIterations,
        ...
        ReingoldFruchtermanLayout.prototype.setInitialRendering = function (
          enable
        ) {
          this.initialRendering = enable;
        };
        ReingoldFruchtermanLayout.prototype.createQuadTree = function () {
          this.quadTree = new Networkgraph_QuadTree(
            this.box.left,
            this.box.top,
            this.box.width,
            this.box.height
        ...
        ReingoldFruchtermanLayout.prototype.setCircularPositions = function () {
          ...
          // eachother.
          for (
            var _i = 0, rootNodes_1 = rootNodes;
            _i < rootNodes_1.length;
            _i++
          ) {
          ...
          for (var i = 0, iEnd = sortedNodes.length; i < iEnd; ++i) {
            node = sortedNodes[i];
            node.plotX = node.prevX = ReingoldFruchtermanLayout_pick(
              node.plotX,
              box.width / 2 + radius * Math.cos(i * angle)
            );
            node.plotY = node.prevY = ReingoldFruchtermanLayout_pick(
              node.plotY,
        ...
        ReingoldFruchtermanLayout.prototype.barnesHutApproximation = function (
          node,
          quadNode
        ) {
          var distanceXY = this.getDistXY(node, quadNode),
          ...
          if (node !== quadNode && distanceR !== 0) {
            if (quadNode.isInternal) {
              // Internal node:
              if (
                quadNode.boxSize / distanceR < this.options.theta &&
                distanceR !== 0
              ) {
        ...
        ReingoldFruchtermanLayout.prototype.repulsiveForces = function () {
          ...
          if (this.approximation === 'barnes-hut') {
            var _loop_1 = function (node) {
              this_1.quadTree.visitNodeRecursive(null, function (quadNode) {
                return _this.barnesHutApproximation(node, quadNode);
              });
            };
            var this_1 = this;
            for (var _i = 0, _a = this.nodes; _i < _a.length; _i++) {
         ...
         * @private
         */
        ReingoldFruchtermanLayout.prototype.applyLimitBox = function (
          node,
          box
        ) {
        ...
        */
         ...
         * @private
         */
        ReingoldFruchtermanLayout.prototype.coolDown = function (
          temperature,
          temperatureStep,
          currentStep
        ) {
        ...
        */
        ...
        ReingoldFruchtermanLayout.prototype.getDistXY = function (
          nodeA,
          nodeB
        ) {
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_ReingoldFruchtermanLayout =
        ReingoldFruchtermanLayout; // ./code/es5/es-modules/Series/SimulationSeriesUtilities.js
      ...
      var SimulationSeriesUtilities_merge =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .merge,
        syncTimeout =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
      ...
      function initDataLabelsDefer() {
        ...
        if (
          !(dlOptions === null || dlOptions === void 0
            ? void 0
            : dlOptions.defer) ||
          !((_a = this.options.layoutAlgorithm) === null || _a === void 0
            ? void 0
            : _a.enableSimulation)
        ) {
      ...
      function initDataLabels() {
        ...
        series.dataLabelsGroup.attr(
          SimulationSeriesUtilities_merge(
            { opacity: 1 },
      ...
      /* harmony default export */ var SimulationSeriesUtilities =
        DataLabelsDeferUtils; // ./code/es5/es-modules/Extensions/TextPath.js
      ...
      function setTextPath(path, textPathOptions) {
        var _this = this;
        // Defaults
        textPathOptions = TextPath_merge(
          true,
          {
            enabled: true,
            attributes: {
        ...
        var bBox = event.bBox,
          tp =
            (_a = this.element) === null || _a === void 0
              ? void 0
              : _a.querySelector('textPath');
        if (tp) {
          var polygon = [],
            _b = this.renderer.fontMetrics(this.element),
            b_1 = _b.b,
            h = _b.h,
            descender_1 = h - b_1,
          ...
          var appendTopAndBottom = function (charIndex, positionOfChar) {
            ...
            return [
              [x - descender_1 * cosRot, y - descender_1 * sinRot],
              [x + b_1 * cosRot, y + b_1 * sinRot],
            ];
          };
          for (var i = 0, lineIndex = 0; lineIndex < numOfLines; lineIndex++) {
            ...
            for (
              ...
              try {
                var srcCharIndex = i + lineCharIndex + lineIndex,
                  _c = appendTopAndBottom(
                    srcCharIndex,
            ...
            try {
              var srcCharIndex = i + lineIndex,
                ...
                _d = appendTopAndBottom(srcCharIndex, charPos),
                lower = _d[0],
                upper = _d[1];
              polygon.unshift(upper);
      ...
      function drawTextPath(event) {
        ...
        if (textPathOptions && !labelOptions.useHTML) {
          this.setTextPath(
            ((_a = point.getDataLabelPath) === null || _a === void 0
              ? void 0
              : _a.call(point, this)) || point.graphic,
            textPathOptions
          );
      ...
      /* harmony default export */ var Extensions_TextPath = TextPath; // ./code/es5/es-modules/Series/Networkgraph/NetworkgraphSeries.js
      ...
      var NetworkgraphSeries_extends =
        (undefined && undefined.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
            extendStatics =
      ...
      var Series =
          highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
            .series,
        NetworkgraphSeries_a =
          highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
            .seriesTypes,
        columnProto = NetworkgraphSeries_a.column.prototype,
        lineProto = NetworkgraphSeries_a.line.prototype;

      var NetworkgraphSeries_initDataLabels =
          SimulationSeriesUtilities.initDataLabels,
        NetworkgraphSeries_initDataLabelsDefer =
          SimulationSeriesUtilities.initDataLabelsDefer;

      var NetworkgraphSeries_addEvent =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .addEvent,
        NetworkgraphSeries_defined =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .defined,
        NetworkgraphSeries_extend =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .extend,
        NetworkgraphSeries_merge =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .merge,
        NetworkgraphSeries_pick =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .pick;

      Extensions_TextPath.compose(
      ...
      var NetworkgraphSeries = /** @class */ (function (_super) {
        ...
        NetworkgraphSeries.prototype.deferLayout = function () {
          ...
          if (!layout) {
            layoutOptions.enableSimulation = !NetworkgraphSeries_defined(
        ...
        NetworkgraphSeries.prototype.generatePoints = function () {
          ...
          if (this.options.nodes) {
            this.options.nodes.forEach(function (nodeOptions) {
              if (!this.nodeLookup[nodeOptions.id]) {
                this.nodeLookup[nodeOptions.id] = this.createNode(
                  nodeOptions.id
                );
              }
            }, this);
          ...
          for (i = this.nodes.length - 1; i >= 0; i--) {
            ...
            node.radius = NetworkgraphSeries_pick(
        ...
        NetworkgraphSeries.prototype.pointAttribs = function (point, state) {
          ...
          var attribs = Series.prototype.pointAttribs.call(
            this,
            point,
            pointState
          );
          if (point && !point.isNode) {
            ...
            if (stateOptions) {
              attribs = {
                ...
                opacity: NetworkgraphSeries_pick(
        ...
        NetworkgraphSeries.defaultOptions = NetworkgraphSeries_merge(
          Series.defaultOptions,
          Networkgraph_NetworkgraphSeriesDefaults
        );
      ...
      highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default().registerSeriesType(
        'networkgraph',
        NetworkgraphSeries
      );
      /* *
       ...
       *
       * */
      /* harmony default export */ var Networkgraph_NetworkgraphSeries =
        NetworkgraphSeries;
      /* *
       *
       *  API Declarations
       ...
       */
      (''); // Detach doclets above // ./code/es5/es-modules/masters/modules/networkgraph.src.js

      var G =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
      Networkgraph_NetworkgraphSeries.compose(G.Chart);
      /* harmony default export */ var networkgraph_src =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
