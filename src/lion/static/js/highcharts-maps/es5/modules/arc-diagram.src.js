...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['highcharts/modules/arc-diagram'] = factory(
      require('highcharts'),
      require('highcharts')['SeriesRegistry'],
      require('highcharts')['Series'],
      require('highcharts')['SVGRenderer'],
  ...
  function (
    ...
    return /******/ (function () {
      ...
      __webpack_require__.d(__webpack_exports__, {
        default: function () {
          return /* binding */ arc_diagram_src;
        },
      });
      ...
      /* harmony default export */ var Series_NodesComposition =
        NodesComposition; // ./code/es5/es-modules/Series/ArcDiagram/ArcDiagramPoint.js
      ...
      var SankeyPoint =
        highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
          .seriesTypes.sankey.prototype.pointClass;

      var ArcDiagramPoint_extend =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
          .extend;
      /* *
       *
       ...
       *
       * */
      /* harmony default export */ var ArcDiagram_ArcDiagramPoint =
        ArcDiagramPoint; // ./code/es5/es-modules/Series/ArcDiagram/ArcDiagramSeriesDefaults.js
       ...
       *
       * */
      /* harmony default export */ var ArcDiagram_ArcDiagramSeriesDefaults =
        ArcDiagramSeriesDefaults; // ./code/es5/es-modules/Series/Sankey/SankeyColumnComposition.js
      ...
      var highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      var highcharts_SVGRenderer_commonjs_highcharts_SVGRenderer_commonjs2_highcharts_SVGRenderer_root_Highcharts_SVGRenderer_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      /* harmony default export */ var Extensions_TextPath = TextPath; // ./code/es5/es-modules/Series/ArcDiagram/ArcDiagramSeries.js
      ...
      var symbols =
        highcharts_SVGRenderer_commonjs_highcharts_SVGRenderer_commonjs2_highcharts_SVGRenderer_root_Highcharts_SVGRenderer_default()
          .prototype.symbols;
      var ArcDiagramSeries_a =
          highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
            .seriesTypes,
        ColumnSeries = ArcDiagramSeries_a.column,
        SankeySeries = ArcDiagramSeries_a.sankey;
      var crisp =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .crisp,
        ArcDiagramSeries_extend =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .extend,
        ArcDiagramSeries_merge =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .merge,
        ArcDiagramSeries_pick =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .pick,
        ArcDiagramSeries_relativeLength =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .relativeLength;
      /* *
       *
      ...
      var ArcDiagramSeries = /** @class */ (function (_super) {
        ...
        ArcDiagramSeries.prototype.createNodeColumns = function () {
          ...
          column.sankeyColumn.offset = function (node, factor) {
            ...
            var offset = column.sankeyColumn.additionalSpace || 0,
              totalNodeOffset;
            for (var i = 0; i < column.length; i++) {
              var sum = column[i].getSum() * (column.sankeyColumn.scale || 0);
        ...
        ArcDiagramSeries.prototype.translateLink = function (point) {
          ...
          var series = this,
            ...
            linkWeight = ArcDiagramSeries_pick(
        ...
        ArcDiagramSeries.prototype.translateNode = function (node, column) {
          ...
          var series = this,
            ...
            lineWidth =
              ((_a = options.marker) === null || _a === void 0
                ? void 0
                : _a.lineWidth) || 0,
            ...
            markerOptions = ArcDiagramSeries_merge(
              options.marker,
              node.options.marker
            ),
        ...
        ArcDiagramSeries.prototype.pointAttribs = function (
          point,
          ...
          if (point && point.isNode) {
            var attrs = __rest(
              highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default().prototype.pointAttribs.apply(
                this,
                arguments
              ),
              []
         ...
         *
         * */
        ArcDiagramSeries.defaultOptions = ArcDiagramSeries_merge(
          SankeySeries.defaultOptions,
          ArcDiagram_ArcDiagramSeriesDefaults
        );
       ...
       *
       * */
      /* harmony default export */ var ArcDiagram_ArcDiagramSeries =
        /* unused pure expression or super */ null && ArcDiagramSeries; // ./code/es5/es-modules/masters/modules/arc-diagram.src.js

      /* harmony default export */ var arc_diagram_src =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
