...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    define('highcharts/modules/sankey', [
    ...
    exports['highcharts/modules/sankey'] = factory(
      require('highcharts'),
      require('highcharts')['SeriesRegistry'],
      require('highcharts')['Point'],
      require('highcharts')['Color'],
  ...
  function (
    ...
    __WEBPACK_EXTERNAL_MODULE__620__,
    ...
    return /******/ (function () {
      ...
      var highcharts_Point_commonjs_highcharts_Point_commonjs2_highcharts_Point_root_Highcharts_Point_ =
        __webpack_require__(260);
      var highcharts_Point_commonjs_highcharts_Point_commonjs2_highcharts_Point_root_Highcharts_Point_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      var SankeyPoint = /** @class */ (function (_super) {
        ...
        SankeyPoint.prototype.applyOptions = function (options, x) {
          highcharts_Point_commonjs_highcharts_Point_commonjs2_highcharts_Point_root_Highcharts_Point_default().prototype.applyOptions.call(
            this,
            options,
            x
          );
        ...
        SankeyPoint.prototype.getClassName = function () {
          return (
            ...
            highcharts_Point_commonjs_highcharts_Point_commonjs2_highcharts_Point_root_Highcharts_Point_default().prototype.getClassName.call(
              this
            )
          );
        };
        ...
        SankeyPoint.prototype.getFromNode = function () {
          ...
          for (var i = 0; i < node.linksTo.length; i++) {
            ...
            if (
              point.fromNode.column > fromColumn &&
       ...
       *
       * */
      /* harmony default export */ var Sankey_SankeyPoint = SankeyPoint; // ./code/es5/es-modules/Series/Sankey/SankeySeriesDefaults.js
       ...
       *
       * */
      /* harmony default export */ var Sankey_SankeySeriesDefaults =
        SankeySeriesDefaults; // ./code/es5/es-modules/Series/Sankey/SankeyColumnComposition.js
      ...
      var SankeyColumnComposition_defined =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
            .defined,
        getAlignFactor =
          highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()
      ...
      (function (SankeyColumnComposition) {
        ...
        function compose(points, series) {
          ...
          sankeyColumnArray.sankeyColumn = new SankeyColumnAdditions(
            sankeyColumnArray,
            series
          );
        ...
        var SankeyColumnAdditions = /** @class */ (function () {
           ...
           * Translation Factor
           */
          SankeyColumnAdditions.prototype.getTranslationFactor = function (
            series
          ) {
          ...
          SankeyColumnAdditions.prototype.top = function (factor) {
            var series = this.series,
              ...
              height = this.points.reduce(function (height, node) {
                if (height > 0) {
                  height += nodePadding;
                }
          ...
          SankeyColumnAdditions.prototype.left = function (factor) {
            var series = this.series,
              ...
              maxNodesLength = chart.inverted
                ...
                : chart.plotWidth,
              nodePadding = series.nodePadding,
              width = this.points.reduce(function (width, node) {
                if (width > 0) {
                  width += nodePadding;
                }
            ...
            for (var i = 0; i < column.length; i++) {
              ...
              if (column[i] === node) {
                return {
                  relativeTop:
                    offset +
                    (SankeyColumnComposition_defined(directionOffset)
       ...
       *
       * */
      /* harmony default export */ var Sankey_SankeyColumnComposition =
      ...
      var highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default =
        /*#__PURE__*/ __webpack_require__.n(
      ...
      function getColor(node, options) {
        ...
        var variateColor = function (color) {
          ...
          if (
            ...
            return highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default()
              .parse(color)
          ...
          if (isArray(levels)) {
            converted = levels.reduce(function (obj, item) {
              ...
              if (isObject(item) && isNumber(item.level)) {
                ...
                levelIsConstant = TreeUtilities_pick(
      ...
      /* harmony default export */ var Extensions_TextPath = TextPath; // ./code/es5/es-modules/Series/Sankey/SankeySeries.js
      ...
      var SankeySeries_a =
          highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()
            .seriesTypes,
        SankeySeries_ColumnSeries = SankeySeries_a.column,
        LineSeries = SankeySeries_a.line;

      var color =
        highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default()
          .parse;

      var SankeySeries_getLevelOptions = Series_TreeUtilities.getLevelOptions,
        SankeySeries_getNodeWidth = Series_TreeUtilities.getNodeWidth;
      ...
      var SankeySeries = /** @class */ (function (_super) {
        ...
        SankeySeries.prototype.createNodeColumns = function () {
          ...
          for (var _i = 0, _a = this.nodes; _i < _a.length; _i++) {
            ...
            if (!columns[node.column]) {
              columns[node.column] = Sankey_SankeyColumnComposition.compose(
                [],
                this
              );
            }
          ...
          for (var i = 0; i < columns.length; i++) {
            if (typeof columns[i] === 'undefined') {
              columns[i] = Sankey_SankeyColumnComposition.compose([], this);
            }
          }
          return columns;
        };
        ...
        SankeySeries.prototype.drawTracker = function () {
          SankeySeries_ColumnSeries.prototype.drawTracker.call(
            this,
            this.points
          );
          SankeySeries_ColumnSeries.prototype.drawTracker.call(
        ...
        SankeySeries.prototype.drawPoints = function () {
          SankeySeries_ColumnSeries.prototype.drawPoints.call(
            this,
            this.points
          );
        ...
        SankeySeries.prototype.drawDataLabels = function () {
          SankeySeries_ColumnSeries.prototype.drawDataLabels.call(
            this,
            this.points
          );
          SankeySeries_ColumnSeries.prototype.drawDataLabels.call(
        ...
        SankeySeries.prototype.translate = function () {
          ...
          Infinity);
          this.colDistance =
            (chart.plotSizeX - this.nodeWidth - options.borderWidth) /
          ...
          for (
            var _i = 0, nodeColumns_1 = nodeColumns;
            _i < nodeColumns_1.length;
            _i++
          ) {
        ...
        SankeySeries.prototype.translateLink = function (point) {
          ...
          var fromNode = point.fromNode,
            ...
            options = this.options,
            linkColorMode = SankeySeries_pick(
              point.linkColorMode,
          ...
          point.tooltipPos = chart.inverted
            ...
            : [point.dlBox.x, point.dlBox.y + linkHeight / 2];
        ...
        SankeySeries.prototype.translateNode = function (node, column) {
          var translationFactor = this.translationFactor,
            ...
            left =
              crisp(
                this.colDistance * node.column + borderWidth / 2,
                borderWidth
              ) +
              SankeySeries_relativeLength(
                node.options[
                  chart.inverted ? 'offsetVertical' : 'offsetHorizontal'
                ] || 0,
                nodeWidth
              ),
         ...
         *
         * */
        SankeySeries.defaultOptions = SankeySeries_merge(
          SankeySeries_ColumnSeries.defaultOptions,
          Sankey_SankeySeriesDefaults
        );
        return SankeySeries;
       ...
       *
       * */
      /* harmony default export */ var Sankey_SankeySeries =
        /* unused pure expression or super */ null && SankeySeries;
      /* *
       *
       *  API Declarations
       *
       ...
       */
      (''); // Detach doclets above // ./code/es5/es-modules/masters/modules/sankey.src.js

      /* harmony default export */ var sankey_src =
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default();
