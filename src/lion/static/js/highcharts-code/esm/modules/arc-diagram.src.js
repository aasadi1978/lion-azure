...
var y = (x) => () => x;
const external_sankey_src_js_namespaceObject = x({}); // external ["../highcharts.src.js","default","SeriesRegistry"]
 ...
 *
 * */
/* harmony default export */ const Series_NodesComposition = NodesComposition; // ./code/es-modules/Series/ArcDiagram/ArcDiagramPoint.js
...
const { extend: ArcDiagramPoint_extend } =
  external_highcharts_src_js_default_default();
/* *
 *
 *  Class
 ...
 *
 * */
/* harmony default export */ const ArcDiagram_ArcDiagramPoint = ArcDiagramPoint; // ./code/es-modules/Series/ArcDiagram/ArcDiagramSeriesDefaults.js
 ...
 *
 * */
/* harmony default export */ const ArcDiagram_ArcDiagramSeriesDefaults =
  ArcDiagramSeriesDefaults; // ./code/es-modules/Series/Sankey/SankeyColumnComposition.js
...
/* harmony default export */ const Sankey_SankeyColumnComposition =
  SankeyColumnComposition; // external ["../highcharts.src.js","default","Series"]

const external_highcharts_src_js_default_Series_namespaceObject =
  __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__['default'].Series;
var external_highcharts_src_js_default_Series_default =
  /*#__PURE__*/ __webpack_require__.n(
...
const external_highcharts_src_js_default_SVGRenderer_namespaceObject =
  __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__['default']
    .SVGRenderer;
var external_highcharts_src_js_default_SVGRenderer_default =
  /*#__PURE__*/ __webpack_require__.n(
...
/* harmony default export */ const Extensions_TextPath = TextPath; // ./code/es-modules/Series/ArcDiagram/ArcDiagramSeries.js
...
const {
  crisp,
  extend: ArcDiagramSeries_extend,
  merge: ArcDiagramSeries_merge,
  pick: ArcDiagramSeries_pick,
  relativeLength: ArcDiagramSeries_relativeLength,
} = external_highcharts_src_js_default_default();
/* *
 *
 *  Class
...
class ArcDiagramSeries extends SankeySeries {
  ...
  createNodeColumns() {
    ...
    column.sankeyColumn.getTranslationFactor = (series) => {
      ...
      let skipPoint,
        ...
        remainingWidth =
          (chart.plotSizeX || 0) -
          ((series.options.marker && series.options.marker.lineWidth) || 0) -
          (column.length - 1) * series.nodePadding;
      // Because the minLinkWidth option doesn't obey the direct
  ...
  translateLink(point) {
    ...
    const getX = (node, fromOrTo) => {
      const linkLeft = (node.offset(point, fromOrTo) || 0) * translationFactor;
      const x = Math.min(
        node.nodeX + linkLeft,
    ...
    let fromX = centeredLinks
        ? fromNode.nodeX + ((fromNode.shapeArgs.height || 0) - linkWeight) / 2
  ...
  pointAttribs(
    ...
    if (point && point.isNode) {
      const { ...attrs } =
        external_highcharts_src_js_default_Series_default().prototype.pointAttribs.apply(
          this,
          arguments
        );
      return attrs;
 ...
 *
 * */
/* harmony default export */ const ArcDiagram_ArcDiagramSeries =
  /* unused pure expression or super */ null && ArcDiagramSeries; // ./code/es-modules/masters/modules/arc-diagram.src.js

/* harmony default export */ const arc_diagram_src =
  external_highcharts_src_js_default_default();
