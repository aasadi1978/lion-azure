...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(
      root['_Highcharts'],
      root['_Highcharts']['SVGElement'],
      root['_Highcharts']['SeriesRegistry']
    );
  else if (typeof define === 'function' && define.amd)
    define('highcharts/modules/networkgraph', [
      'highcharts/highcharts',
    ], function (amd1) {
      return factory(amd1, amd1['SVGElement'], amd1['SeriesRegistry']);
    });
  ...
  (
    __WEBPACK_EXTERNAL_MODULE__563__,
    ...
    return /******/ (() => {
            ...
            (event) => {
              ...
              if (
                ...
                mousemoveUnbinder = addEvent(
                  ...
                  'mousemove',
                  (e) =>
                    point && point.series && point.series.onMouseMove(point, e)
                );
        ...
        function createNode(id) {
          ...
          if (!node) {
            ...
            newNode.hasShape = function () {
              ...
              return (
                !newNode.linksTo.length || outgoing !== newNode.linksTo.length
              );
            };
       ...
       *
       * */
      /* harmony default export */ const Series_NodesComposition =
        NodesComposition; // ./code/es-modules/Series/Networkgraph/NetworkgraphPoint.js
       ...
       *
       * */
      /* harmony default export */ const Networkgraph_QuadTreeNode =
        QuadTreeNode; // ./code/es-modules/Series/Networkgraph/QuadTree.js
      ...
      class NetworkgraphSeries extends Series {
        ...
        markerAttribs(point, state) {
          const attribs = Series.prototype.markerAttribs.call(
            this,
            point,
            state
          );
