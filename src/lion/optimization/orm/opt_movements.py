...
class OptimizationMovements(LION_SQLALCHEMY_DB.Model):
    ...
    def __init__(self, **attrs):
        ...
        self.user_id = LION_FLASK_APP.config['LION_USER_ID']
    ...
    def add_dct_m(cls, dct_m={}):
        ...
        try:
            ...
            if record is not None:
                ...
                record = OptimizationMovements(str_id=dct_m['str_id'],
